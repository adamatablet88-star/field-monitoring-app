import type { FrequencyValue } from "@field-monitoring/shared";
import { FREQUENCY_DAYS } from "@field-monitoring/shared";
 ...
 * cycle is ~73 days since the last visit. Not specified in the source
 * docs; a reasonable judgment call so "what's due this month" has
 * somewhere to flag before something actually lapses.
 */
