...
import { FuelLensExportButton } from "../export/FuelLensExportButton";
import "./trends.css";
...
export function TrendsView() {
  ...
  const { items: systems } = useLocalCollection<TreatmentSystem>(db.treatmentSystems, "treatmentSystem");
