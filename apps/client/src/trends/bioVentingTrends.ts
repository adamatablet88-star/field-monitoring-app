import type { BioVentingSystemVisit } from "@field-monitoring/shared";
...
/**
 * A monitoring point can carry several depths (see MonitoringPointReading
 * in packages/shared/src/visits.ts) — a per-visit trend needs one number,
 * so O2/CO2 are averaged across every depth of every point that visit.
 * Not specified in the source docs; a reasonable simplification for a
 * system-level trend line.
 */
