...
import type { RegulatoryReport, RegulatoryReportStatus, RegulatoryReportType } from "@field-monitoring/shared";
import { db } from "../db";
...
export function RegulatoryReportsPanel({ siteId }: RegulatoryReportsPanelProps) {
  const { items: allReports, save, remove } = useLocalCollection<RegulatoryReport>(db.regulatoryReports, "regulatoryReport");
