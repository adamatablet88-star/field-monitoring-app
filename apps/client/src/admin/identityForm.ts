import type { WellIdentity } from "@field-monitoring/shared";

/**
 * Shared editable-draft shape for the "physical identity" fields common
 * to fuel-lens wells and treatment wells (docs/data-model.md section 2):
 * X/Y/Z, manhole, depth/diameter, screened interval. Kept as strings
 * while editing so number inputs can be temporarily empty/partial.
 */
