...
import type { ScheduledSpecialTest, SpecialTestType, SystemType, TreatmentSystem } from "@field-monitoring/shared";
import { db } from "../db";
...
/** TO-15: quarterly for SVE, annual for Bio-venting. Oxygen test: annual, Bio-venting only — docs/business-logic.md 5.2. */
...
export function ScheduledSpecialTestsPanel({ siteId }: ScheduledSpecialTestsPanelProps) {
  const { items: allTests, save, remove } = useLocalCollection<ScheduledSpecialTest>(
    db.scheduledSpecialTests,
