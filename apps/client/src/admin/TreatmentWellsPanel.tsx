...
import type { TreatmentWell, TreatmentWellType } from "@field-monitoring/shared";
import { db } from "../db";
...
export function TreatmentWellsPanel({ systemId }: TreatmentWellsPanelProps) {
  const { items: allWells, save, remove } = useLocalCollection<TreatmentWell>(db.treatmentWells, "treatmentWell");
