...
import type { GroundwaterWell } from "@field-monitoring/shared";
import { db } from "../db";
...
export function GroundwaterWellsPanel({ siteId }: GroundwaterWellsPanelProps) {
  const { items: allWells, save, remove } = useLocalCollection<GroundwaterWell>(db.groundwaterWells, "groundwaterWell");
