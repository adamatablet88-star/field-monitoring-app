import type { StabilizationReading } from "@field-monitoring/shared";
...
/**
 * Stabilization rule (docs/business-logic.md 4.3): 3 consecutive readings
 * within criteria for every criterion-bearing parameter. Turbidity's ±10%
 * only applies once turbidity is above 10 NTU; temp has no criterion.
 */
