import type { CriticalDirection } from "@field-monitoring/shared";
...
/**
 * Generic critical-threshold check — see docs/data-model.md section 8.
 * Independent of the normal soft-warning range; a caller decides what
 * config to check a value against (an admin-defined ParameterConfig, or
 * a sensible built-in default like PID-after-treatment > 50ppm).
 */
