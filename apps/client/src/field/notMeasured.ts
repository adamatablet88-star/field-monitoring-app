import type { NotMeasuredField, NotMeasuredReason } from "@field-monitoring/shared";

/** Editable-draft mirror of NotMeasuredField<number> — see identityForm.ts for the same pattern. */
