...
export function TreatmentSystemList({ siteId, systemType }: TreatmentSystemListProps) {
  ...
  const sveVisits = useLocalCollection(db.sveSystemVisits, "sveSystemVisit").items;
  const bioVentingVisits = useLocalCollection(db.bioVentingSystemVisits, "bioVentingSystemVisit").items;
