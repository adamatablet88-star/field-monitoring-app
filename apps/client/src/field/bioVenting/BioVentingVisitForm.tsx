...
import type { BioVentingSystemVisit, ParameterReading, TreatmentSystem, TreatmentWell } from "@field-monitoring/shared";
import { db } from "../../db";
...
export function BioVentingVisitForm({ system, onDone }: BioVentingVisitFormProps) {
  const { items: visits, save } = useLocalCollection<BioVentingSystemVisit>(db.bioVentingSystemVisits, "bioVentingSystemVisit");
