import type { MonitoringPointDepthReading } from "@field-monitoring/shared";
import { newId } from "../../admin/useLocalCollection";
...
/** Variable number of monitoring points, each with a variable number of depths — docs/business-logic.md 3.2. */
